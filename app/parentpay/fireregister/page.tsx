                    ...
                    <div className='flex-col  space-y-8'>
                        ...
                        <div className='flex-col  space-y-8'>
                            <div className='flex-col'>
                                ...
                                <ul className="px-6">
                                    <li className="list-disc w-full">Conduct surveys and interviews with teachers, admins, and fire wardens.</li>
                                    <li className="list-disc w-full">Observe fire drills and evacuation processes in schools.</li>
                                </ul>
                            </div>
                            <div className='flex-col'>
                                <h2 className='flex text-2xl font-bold'>Participants</h2>
                                <ul className="px-6">
                                    <li className="list-disc w-full">Teachers from different year groups.</li>
                                    <li className="list-disc w-full">School administrators and fire wardens.</li>
                                    <li className="list-disc w-full">IT staff managing the school MIS (Management Information System).</li>
                                </ul>
                            </div>
                            <div className='flex-col'>
                                ...
                                <div className='flex-col'>
                                    ...
                                    <ul className="px-6">
                                        <li className="list-disc w-full">Quick and easy access to the register during fire drills.</li>
                                        <li className="list-disc w-full">Ability to mark attendance quickly and accurately.</li>
                                        <li className="list-disc w-full">Instant notification of missing pupils.</li>
                                    </ul>
                                </div>
                                <div className='flex-col'>
                                    <h3 className='flex text-xl font-bold mt-4'>Admins/Fire Wardens</h3>
                                    <ul className="px-6">
                                        <li className="list-disc w-full">Real-time updates on the status of all classes.</li>
                                        <li className="list-disc w-full">A comprehensive view of missing pupils across the school.</li>
                                        <li className="list-disc w-full">Assurance that all pupils are accounted for.</li>
                                    </ul>
                                </div>
                            ...
                            <div className='flex-col'>
                                ...
                                <div className='flex-col'>
                                    <h3 className='flex text-xl font-bold mt-4'>Teachers</h3>
                                    <ul className="px-6">
                                        <li className="list-disc w-full">Time-consuming process of using paper registers.</li>
                                        <li className="list-disc w-full">Risk of human error in marking attendance.</li>
                                        <li className="list-disc w-full">Difficulty in ensuring all pupils are safe and accounted for.</li>
                                    </ul>
                                </div>
                                <div className='flex-col'>
                                    <h3 className='flex text-xl font-bold mt-4'>Admins/Fire Wardens</h3>
                                    <ul className="px-6">
                                        <li className="list-disc w-full">Delays in receiving attendance information.</li>
                                        <li className="list-disc w-full">Challenges in coordinating with teachers on the ground.</li>
                                        <li className="list-disc w-full">Inefficiency in tracking and locating missing pupils.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
