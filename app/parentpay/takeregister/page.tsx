                    ...
                    <div className='flex-col  space-y-8'>
                        ...
                        <div className='flex-col  space-y-8'>
                            <div className='flex-col space-y-4'>
                                ...
                                <ul className="px-6">
                                    <li className="list-disc w-full">UK Primary school teachers</li>
                                    <li className="list-disc w-full">UK Secondary school teachers</li>
                                </ul>
                            </div>
                            <div className='flex-col space-y-4'>
                                <h2 className='flex text-2xl font-bold'>Existing apps</h2>
                                <ul className="px-6">
                                    <li className="list-disc w-full">SIMS Legacy app</li>
                                    <li className="list-disc w-full">Other - Bromcom,Arbor,Edulink</li>
                                </ul>
                            </div>
                            <div className='flex-col'>
                                <h2 className='flex text-2xl font-bold'> User needs</h2>
                                <ul className="px-6">
                                    <li className="list-disc w-full">Need to take register as quick as possible and move on to teaching</li>
                                    <li className="list-disc w-full">Mark students as per the UK DFE code guidelines and add relative comment</li>
                                    <li className="list-disc w-full">Ensure all students are marked to make sure safegaurding of students</li>
                                    <li className="list-disc w-full">In secondary display all lesson attendace marks to teacher to keep informed abnout student&apos;s wherabouts</li>
                                    <li className="list-disc w-full">Select meal choice of the students while taking register so canteen will be informed</li>
                                </ul>
                            </div>
                            <div className='flex-col'>
                                <h2 className='flex text-2xl font-bold'> User Pain Points</h2>
                                <ul className="px-6">
                                    <li className="list-disc w-full"> For teacher taking register is one of the to-do thing and note the primary task</li>
                                    <li className="list-disc w-full"> Legacy system takes time to mark all students</li>
                                    <li className="list-disc w-full"> Admin has to chase teachers to mark all students and complete the register</li>
                                    <li className="list-disc w-full"> To take dinner register teacher had to navigate to another screen</li>
                                    <li className="list-disc w-full"> Cannot see the summary of the class on quick glance</li>
                                    <li className="list-disc w-full"> Marking student late becomes difficult in legacy system if students come in between teaching</li>
                                </ul>
                            </div>
                        </div>
                    </div>
