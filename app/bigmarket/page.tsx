        ...
        <div className=' min-h-screen'>
            <TracingBeam className="px-6 ">
                ...
                <div className='flex-col space-y-16 '>
                    ...
                    <div className='flex-col  space-y-8'>
                        <h1 className='flex text-4xl font-bold  min-w-44'>User Persona</h1>
                    ...
                    <div className='flex-col  space-y-8'>
                        <h1 className='flex text-3xl font-bold  min-w-44'>Secondary Research: Competitive Analysis</h1>
                    ...
                    <div className='flex-col  space-y-8'>
                        <h1 className='flex text-4xl font-bold  min-w-44'>Information Architeture</h1>
