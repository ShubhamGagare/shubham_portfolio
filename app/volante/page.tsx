                ...
                <div className='flex-col space-y-16 '>
                    ...
                    <div className='flex gap-8'>
                        ...
                        <div className='flex-col  space-y-8'>
                            <div className='flex-col mt-2'>
                                <ul>
                                    <li>The only users are the testers from the different QA teams.</li>
                                    <li>Testers spend most of the time configuring testcase.</li>
                                    <li>As the VolPay gets enhanced new testcase cannot be configured in existing tool.</li>
                                    <li>Despite the backend support due to fronend limitations all testcase was not configurable.</li>
                    ...
                    <div className='flex gap-8'>
                        ...
                        <div className='flex-col  space-y-8'>
                            <div className='flex-col mt-2'>
                                <ul>
                                    <li>Redesigned TestSuite can automate 70% of the testcase.</li>
                                    <li>It saves valuable time of the manual testers.</li>
                                    <li>TestCase configuration,automation and monitoring became easy.</li>
                                    <li>Improved Quality Assurance at making sense.</li>
                    ...
                    <div className='flex gap-8'>
                        ...
                        <div className='flex-col'>
                            ...
                            <div className='flex-col mt-2'>
                                <ul>
                                    <li>Gathering the testing requirements and understanding new functionalities of the VolPay.</li>
                                    <li>Based on that designed the solutions which includes UI,backend implementation and DB architure.</li>
                                    <li>Redesigning and deveoping the existing profiles.</li>
                                    <li>Design and develope new profiles and functionalities.</li>
                                    <li>Improving the overall UI time to time as per testers feedback.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='flex gap-8'>
                        ...
                        <div className='flex-col'>
                            <div className='flex-col mt-2'>
                                <ul>
                                    <li>The design and development is been over year,so we were constantly collecting feedback from the VolPay QA team</li>
                                    <li>Initially in testplan to differntiate testcases whole testcase box was colured for differnt levels.Which is now redesigned to colured sidebar of the box</li>
                                    <li>Instead of two output comparison three output comparison was suggested.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
